...
| Abbreviation expansion in Rec Extractor | Not started | cpg-ingester | Before Phase 3.3: refine Rec Extractor prompt to always expand abbreviations on first use in recommendation `content`. Ensures acp-writer's vector store gets self-contained text for semantic search.                                                                                                         |
